 ...
 */
import type { Decision, Forecast, Market, MarketOutcome, SizingPolicy } from "@lykos/core";
...
function findOutcome(market: Market, name: "yes" | "no"): MarketOutcome | undefined {
...
export function decideBet(
  ...
  const units = clamp(Math.round(stakeFraction / policy.unitFraction), 0, policy.maxUnits);
